 ...
 // 	 	  	$.ajax({
	...
	// 		   url: "/product/proexist.php",

	// 		   data: {

	// 		   		"pro_number":$("input[name='pro_order_num']").val()
	...
	// 		   		if(msg == "no"){
	// 		   			$("input[name='pro_order_num']").css("border","1px solid red");
	// 		   			pro_num = false;
	// 		   		}else{
	// 		   			$("input[name='pro_order_num']").css("border","1px solid #CCCCCC");
	// 		   			pro_num = true;
	// 		   		}
