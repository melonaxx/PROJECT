$(function(){
	$(".btn-add").on("click",function(){
		...
		var $td6=$('<td class="danjia"><label class="labelname" style="display:block;float:left;margin-top:5px;">￥</label><input type="text" class="form-control singleprice" name="danjia[]"/></td>');
		var $td7=$('<td><input type="text" class="form-control goodsnum shuliang" placeholder="必填" name="shuliang[]"/></td>');
		var $td8=$('<td ><label class="labelname" style="display:block;float:left;margin-top:5px;">￥</label><input type="text" class="zongjia form-control" style="border:none;width:116px;" readonly="readonly" name="zongjia[]"/></td>');
		var $td9=$('<td ><input type="text" class="form-control shuilv" name="shuilv[]"/></td>');
		var $td10=$('<td ><label class="labelname" style="display:block;float:left;margin-top:5px;">￥</label><input  type="text" class="shuie form-control" style="border:none;width:76px;" readonly="readonly" name="shuie[]"></td>');
		var $td11=$('<td ><label class="labelname" style="display:block;float:left;margin-top:5px;">￥</label><input  type="text" class="shuijia form-control" style="border:none;width:76px;" readonly="readonly" name="shuijia[]"></td>');
		$onetr1.append($td1);
		$onetr1.append($td2);
		$onetr1.append($td3);
		$onetr1.append($td4);
	...
	function taxchange(){
		$(".shuilv").change(function(){
			var shuilv =$(this).val();
			var zongjia = $(this).parent().prev().children("input").val();
			var shuijia = (zongjia/(1+(shuilv/100))).toFixed(2);
			$(this).parent().next().next().children("input").val(shuijia);
			$(this).parent().next().children("input").val((zongjia-shuijia).toFixed(2));
		})
	}
