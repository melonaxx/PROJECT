$(function(){
	...
	$(".btn-add").on("click",function(){
		...
		var $td5=$('<td><select class="form-control searchname"><option></option></select></td>');
		var $td6=$('<td></td>');
		var $td7=$('<td><label class="labelname" style="float:left;display:block;width:20px;height:30px;line-height:30px;">￥</label><input type="text" class="form-control singleprice"></td>');
		var $td8=$('<td><input type="text" class="form-control goodsnum"placeholder="必填"></td>');
		var $td9=$('<td><label class="labelname" style="float:left;display:block;width:20px;height:30px;line-height:30px;">￥</label><input type="text" class="form-control singleprice"></td>');
		var $td10=$('<td><label class="labelname" style="float:left;display:block;width:20px;height:30px;line-height:30px;">￥</label><input type="text" class="form-control singleprice"></td>');
		var $td11=$('<td><input type="text" class="form-control"></td>');
		$onetr.append($td1);
		$onetr.append($td2);
		$onetr.append($td3);
		$onetr.append($td4);
