 ...
 * 未排版印刷单列表
 */
class WPaiPrintBillQuery extends Query
{
	//列出所有的印刷单
	public function listwpaiprintbill($search,$page,$pagesize,$total)
	{
		...
		if ($total == 'list') {
			$sql = "SELECT b.id AS billid,b.createtime,b.content,b.pnumber,b.vnumber,b.orderid,b.stylename,b.printcost,b.tpsetstatus,
