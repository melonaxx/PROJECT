...
if(!empty($_POST['template_info']) && !empty($_POST['template_position'])){
	...
	$sql1 = "SELECT name FROM company_order_template_info WHERE company_id='$company_id' AND name='$name'";
	...
	$sql2 =  "SELECT COUNT(*) as total FROM  company_order_template_info WHERE company_id='$company_id'";
	...
	$sql = "INSERT INTO   company_order_template_info 
