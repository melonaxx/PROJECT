...
include "../function.php";
	...
	if(!empty($_GET['audit'])){
		$id = rtrim(replace_safe($_GET['audit']),",");
		$sql = "UPDATE order_custom SET status ='R' WHERE order_id IN ($id) AND company_id='$company_id'";
	...
	if($main['total'] > 0)
	{
		...
		order_source.order_text,order_source.customer_text,order_source.user_id,
