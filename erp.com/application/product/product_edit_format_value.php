...
$sql	= "SELECT body, format_id FROM product_format_value WHERE company_id='".$_SESSION['_application_info_']['company_id']."' AND id='$id'";
	...
	if(mysql_num_rows($result))
	{
		...
		else
		{
			...
			if($is_delete == 'Y')
			{
				...
				$sql	= "UPDATE product_format_value SET body='".time()."' WHERE id='$old_id'";
				mysql_query($sql,$_mysql_link_);

				$sql	= "UPDATE product_format_value SET body='$name' WHERE id='$id'";
				mysql_query($sql,$_mysql_link_);

				$sql	= "UPDATE product_format_value SET body='$old_name' WHERE id='$old_id'";
				mysql_query($sql,$_mysql_link_);
			}
			else
			{
