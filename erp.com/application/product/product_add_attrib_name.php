...
if(!empty($_POST['name']))
{
	...
	if(mysql_num_rows($result))
	{
		...
		{
			//---- 如果已经删除 则恢复其正常状态 ----
			$sql	= "UPDATE product_attrib_name SET is_delete='N' WHERE id='$old_id'";
	...
	{
		$sql	= "INSERT INTO product_attrib_name SET company_id='".$_SESSION['_application_info_']['company_id']."', name='$name'";
		mysql_query($sql,$_mysql_link_);
