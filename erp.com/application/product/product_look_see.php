...
if(mysql_num_rows($result))
{
	...
	//---- 商品销量表 ----
	$sql = "SELECT sales_status,staff_id,sales_number,sales_volume,profit FROM product_sales WHERE id='$id'";
	$result		= mysql_query($sql, $_mysql_link_);
	if(mysql_num_rows($result))
	{
		...
		//销量
		$main['sale_number']	= $ProductSale->sales_number;
		//销售额
		$main['saleroom'] = $ProductSale->sales_volume;
		//利润
		$main['lirun'] = $ProductSale->profit;
