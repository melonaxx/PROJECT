...
if(!empty($_GET)){
	...
	$sql = "SELECT l.number,l.action_date,l.staff_id,r.tax_type,r.tax_title,r.tax_text FROM finance_tax_logs AS l LEFT JOIN order_receiver AS r ON l.order_id = r.id WHERE l.company_id='$company_id' AND l.order_id = '$id' ";
	$result  = mysql_query($sql,$_mysql_link_);
