...
<div class="mainBody">
	<ul class="nav nav-tabs nav_tabs_margin">
		...
		<li class="active"><a href="/purchase/purchase_tobe_instorage.php">待入库</a></li>
	</ul>
	<form class="form-inline" action="" method="">
		<div class="storageMsg">
			...
			<table class="table table-bordered table-hover">
				...
				<xsl:for-each select="/html/Body/inStorageListMsg/ul/li">
				<tr>
					<td class="center">1</td>
					<td class="center"><a href="/purchase/purchase_in_storage_detail.php">采购入库</a></td>
					<td>2015-08-20</td>
