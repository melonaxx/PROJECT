...
<div class="mainBody">
	<form class="form-inline" action="/purchase/purchase_receivables_detail.php" method="post">
			...
			<div class="commonMsg paymentMsg">
				<div class="form-group">
					...
					<xsl:element name="INPUT">
						...
						<xsl:attribute name="value">采购退货</xsl:attribute>
						<xsl:attribute name="class">form-control input-sm</xsl:attribute>
						<xsl:attribute name="readonly">readonly</xsl:attribute>
					</xsl:element>
				</div>
				...
				<div class="form-group">
					<label class="margin_left_1">收款金额：</label>
				...
				<div class="form-group form-group_bottom0">
					...
					<xsl:element name="INPUT">
						<xsl:attribute name="type">text</xsl:attribute>
						<xsl:attribute name="name">body</xsl:attribute>
						<xsl:attribute name="class">form-control input-sm merger_three_row_9</xsl:attribute>
					</xsl:element>
				</div>
			</div>
		</div>
		<div style='width:100%;float:left;'>
				...
				<span class="view_detail">
					<xsl:element name="A">
						<xsl:attribute name="href">
							/purchase/purchase_waiting_payment.php?purchase_id=<xsl:value-of select="/html/Body/purchase/ul/li/id" />&amp;type=Input&amp;subject=SS</xsl:attribute>
						查看详细
					</xsl:element>
				</span>
			</div>
			...
			<p class="bottom"><input class="btn btn-default btn-sm btn_margin" name='made' type="submit" value="提交" /><input class="btn btn-default btn-sm" type="reset" value="重置" /></p>
		</div>
	</form>
...
<script>
	...
	$('textarea[name=brief]').blur(function(){
		...
		$.ajax({
			url:'purchase_receivables_detail.php',
			type:'post',
	...
	$('.content').dblclick(function(){
		...
		var input = $("&lt;input type='text' style='width:113px;' class='form-control input-sm' value='"+content+"' />");
		td.html(input);
		input.trigger("focus");
		input.blur(function(){
