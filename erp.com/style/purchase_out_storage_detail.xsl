...
<script type="text/javascript" src="/js_encode/purchase_out_storage_detail.js"></script>

<div class="mainBody">
	<form class="form-inline" action="/purchase/purchase_out_storage_detail.php" method="post">
		<div class="base">
		...
		<div class="goodsMsg">
			...
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<td style="width:94px;">
						<input type="text" name="sum[]" value="" class="form-control input-sm" style="width:75px;" autocomplete="off"/>
					</td>
					...
					<td style="width:90px;">
						...
						<xsl:element name="INPUT">
							...
							<xsl:attribute name="type">hidden</xsl:attribute>
							<xsl:attribute name="name">out_sum2[]</xsl:attribute>
							<xsl:attribute name="readonly">readonly</xsl:attribute>
						</xsl:element>
		...
		<div style='width:100%;float:left;background:#eeeeee;'>
			...
			<div class="currentMsg">
				<table class="table table-bordered table-hover">
					...
					<tr style='background:#fff;'>
						...
						<td>
							<input type="text" value='' name="in_sum_rk[]" class="form-control input-sm" style="width:125px;" readonly="readonly"/>
						</td>
						<td>
							<input type="hidden" name="xiaoji[]" class="form-control input-sm" value=""/><span calss="xiaoji"></span>
						</td>
						<td>
			...
			<div class="commonMsg totalMsg1">
				<p>出库数量总计：<input type="hidden" name="zongshu_rk" value="" /><span class="money_color"><span class="zongshu_rk">0</span></span><span style="margin-left:20px;">出库总价：<input type="hidden" name="zongjia_rk" value="" /><span class="money_color"><span class="zongjia_rk">0</span></span>元</span>
				</p>
			</div>
		</div>
			...
			<div class="commonMsg freightMsg">
				...
				<div class="form-group form-group_bottom0">
					...
					<div class="input-group">
						...
						<xsl:element name="INPUT">
							 <xsl:attribute name="type">text</xsl:attribute>
							 <xsl:attribute name="name">freight_amount</xsl:attribute><!--订单优惠字段暂时没有-->
							 <xsl:attribute name="class">form-control input-sm</xsl:attribute>
				...
				<span class="view_detail">
					<xsl:element name="A">
						<xsl:attribute name="href">
							/purchase/purchase_documents_List.php?purchase_id=<xsl:value-of select="/html/Body/purchase/ul/li/number" />&amp;staff=&amp;date=&amp;type=Output</xsl:attribute>
						查看详细
					</xsl:element>
				</span>
			</div>
