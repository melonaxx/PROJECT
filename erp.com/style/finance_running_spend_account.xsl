		...
		<div class="tab-pane" id="RWBE1">
			<div class=" " style="clear:both;">
   				<div class="table_operate_block">
	   				<h4></h4>
					<input class="btn btn-default btn-sm btn_margin payAdd1" type="button" value="添加" onclick="MessageBox('/finance/finance_running_spendadd_account.php', '添加支出科目', 300, 150)"/>
				</div>
				<table class="table table-bordered  ttbale  table-pay">
					<tr>
						<th class="table_th_number">序号</th>
						<th class="table_th_number" style="width:100px;">操作</th>
						<th width="1054px;">支出科目</th>
					</tr>
					...
					<tr>
						...
						<td class="center">
							<xsl:element name="A">
								<xsl:attribute name="href">/finance/finance_running_spendedit_account.php?id=<xsl:value-of select="id"/></xsl:attribute>
								<xsl:attribute name="onclick">MessageBox('/finance/finance_running_spendedit_account.php?id=<xsl:value-of select="id"/>', '修改支出科目信息', 300, 150); return false</xsl:attribute>
							...
							<xsl:element name="SPAN">
								...
								<xsl:attribute name="onclick">MessageBox('/finance/finance_running_spenddelete_account.php?id=<xsl:value-of select="id" />', '删除支出科目', 320, 90)</xsl:attribute>
