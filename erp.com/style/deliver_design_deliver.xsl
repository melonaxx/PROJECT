...
<script type="text/javascript" charset="UTF-8" src="/js_encode/deliver_design_deliver.js"></script>
...
<div class="mainBody" style="margin:2px 0px">
	<div id="myTabContent" class="tab-content">
		...
		<!-- <div class="tab-pane fade in active" id="print_deliver"> -->
		<div class="smallbox">
			<div class="dropdown">
				...
				<div class="dropdown_body">
					<a href="javascript:;" style="margin:0 50px 0 50px;" data-dismiss="modal"  class="btn btn-default btn-sm" id="deliver_template" >切换模板</a>
					<select name="deliver_template" class="form-control input-sm" style="display:none;" >
						<xsl:for-each select="/html/Body/deliver_template/item">
			...
			<div class="dropdown">
					...
					<div class="dropdown_body_body">
						...
						<span style="width:88px;overflow:visible;margin-right:5px;display:inline-block">
							<xsl:element name="INPUT">
								...
								<xsl:attribute name="class">form-control input-sm deliver_item</xsl:attribute>
				...
				<div class="dropdown_body">
					<div class="dropdown_body_header">
			    		<span class="car_left"><span class="caret"></span></span>
						<span class="title">发货单头部</span>
					</div>
					<div class="dropdown_body_body">
						
						<xsl:for-each select="/html/Body/deliver/item">
						<span style="width:88px;overflow:visible;margin-right:5px;display:inline-block">
							<xsl:element name="INPUT">
								<xsl:attribute name="type">checkbox</xsl:attribute>
								<xsl:attribute name="style">width:8px;display:inline;margin: 2px 0px;</xsl:attribute>
				...
				<!-- <div class="dropdown_body">
					...
					<div class="dropdown_body_body">
						<span style="width:88px;overflow:visible;margin-right:5px;display:inline-block">
							<input type="checkbox" style="width:8px;display:inline;margin: 2px 0px;" class="form-control input-sm deliver_item"  value="卖家昵称" aria-describedby="sizing-addon2" id="id"/>
		...
		<div class="box">
			...
			<div id="print_deliver_content" style="display:none;">
				<div id="printi">
