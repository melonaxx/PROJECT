...
<div class="mainBody" style="margin:2px 0px">
	<div id="myTabContent" class="tab-content">
		...
		<!-- <div class="tab-pane fade in active" id="print_shiporder"> -->
		<div class="smallbox">
			<div class="dropdown">
				...
				<div class="dropdown_body">
					<a href="javascript:;" style="margin:0 50px 0 50px;" data-dismiss="modal"  class="btn btn-default btn-sm" id="express_template" >切换模板</a>
					
					<!-- <select name="company_express" class="form-control input-sm" style="display:none;" >
						<xsl:for-each select="/html/Body/compa_express/item">
					...
					<select name="express_template" class="form-control input-sm" style="display:none;" >
					...
					<xsl:element name="LABEL">
						...
						<xsl:attribute name="express_id"><xsl:value-of select="/html/Body/page_info/express_id" /></xsl:attribute>
						模板名称：
					</xsl:element>
			...
			<div class="dropdown">
				...
				<div class="dropdown_body">
					<form action="/deliver/deliver_edit_express_template.php" enctype="multipart/form-data" method="post">
					...
					<xsl:element name="input">
						...
						<xsl:attribute name="value">
							<xsl:value-of select="/html/Body/page_info/template_id" />
						</xsl:attribute>
					</xsl:element>
					<input class="btn btn-default btn-sm" id="upload_pic"  type="button" value="上传图片" />
					<br/>
					...
					<botton class="btn btn-default btn-sm" id="edit_image" data-dismiss="modal">设为背景图片</botton>
					</form>
				</div>
			</div>
 ...
 -->
			...
			<div class="dropdown">
				...
				<!-- <div class="dropdown_body">
					...
					<div class="dropdown_body_body">
						<button class="btn btn-default btn-sm" id="right_sign">  √  </button>
					</div>
				</div> -->
