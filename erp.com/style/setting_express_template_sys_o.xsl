...
<div class="mainBody">
	<div class="headMsg table_operate_block">
		<form action="/setting/setting_express_template_sys_o.php" method="post" class="form-inline">
		...
		<a href="/setting/setting_order_template.php"><input class="btn btn-default btn-sm btn_margin" type="button" value="我的模板" /></a>
	...
	<table style="" class="table tab_select table-bordered table-hover">
		...
		<tr>
			...
			<td class="center">
				...
				<form action="/setting/setting_express_template_sys_o.php?action=add" method="get" >
					<div class="input-group">
						<xsl:element name="INPUT">
