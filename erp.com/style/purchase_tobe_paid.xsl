...
<div class="mainBody">
	...
	<div class="paymentMsg">
		<form class="form-inline" action="/purchase/purchase_tobe_paid.php" method="get">
			...
			<div class="form-group form_small_block" style="float:right;">
				...
				<select class="form-control input-sm" name="status">
					...
					<xsl:element name="OPTION">
					   ...
					   <xsl:if test="'D'=/html/Body/status">
					   		<xsl:attribute name="selected">selected</xsl:attribute>
					   </xsl:if>
					   部分付款
					</xsl:element>
				...
				<td class="center">
					<xsl:element name="A">
					   <xsl:attribute name="href">
					   	/purchase/purchase_payment_detail.php?id=<xsl:value-of select="id"/>
					   </xsl:attribute>
					   付款
					</xsl:element>
				</td>
