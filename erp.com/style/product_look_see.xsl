...
<form class="form-inline margin_top">
...
<h4>商品信息
	<xsl:element name="A">
		<xsl:attribute name="href">/product/product_edit.php?id=<xsl:value-of select="/html/Body/div/id" /></xsl:attribute>
...
<div class="float_left" style="height:250px;width:700px">
	...
	<div class="form-group">
		<label>商品品牌：</label>
		<select class="form-control input-sm" disabled="disabled" name="brand_id">
	...
	<div class="form-group">
		<label>所属店铺：</label>
		<select class="form-control input-sm" disabled="disabled" name="shop_user_id">
	...
	<div class="form-group">
		<label>商品分类：</label>
		<select class="form-control input-sm" disabled="disabled" name="category_id">
			<option value="0"></option>
	...
	<div class="form-group">
		<label>产品类型：</label>
		<select class="form-control input-sm" disabled="disabled" name="product_type">
	...
	<div class="form-group">
		<label>是否二手：</label>
		<select class="form-control input-sm" disabled="disabled" name="product_quality">
	...
	<div class="form-group">
		<label>　　单位：</label>
		<select class="form-control input-sm" disabled="disabled" name="parts_id">
	...
	<div class="form-group">
		<label>在售状态：</label>
		<select class="form-control input-sm" disabled="disabled" name="product_sale">
	...
	<div class="form-group">
		...
		<xsl:element name="INPUT">
			...
			<xsl:attribute name="class">form-control input-sm</xsl:attribute>
			<xsl:attribute name="readonly">readonly</xsl:attribute>
			<xsl:attribute name="value"><xsl:value-of select="/html/Body/snum" /></xsl:attribute>
		</xsl:element>
	</div>
	...
	<div class="form-group">
		...
		<div class="input-group col-xs-7">
			...
			<xsl:element name="INPUT">
				...
				<xsl:attribute name="style">width: 110px;</xsl:attribute>
				<xsl:attribute name="readonly">readonly</xsl:attribute>
				<xsl:attribute name="value"><xsl:value-of select="/html/Body/srom" /></xsl:attribute>
			</xsl:element>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="input-group col-xs-7">
			...
			<xsl:element name="INPUT">
				...
				<xsl:attribute name="style">width: 110px;</xsl:attribute>
				<xsl:attribute name="readonly">readonly</xsl:attribute>
				<xsl:attribute name="value"><xsl:value-of select="/html/Body/lr" /></xsl:attribute>
			</xsl:element>
		</div>
	</div>
</div>
...
<div class="form-group" style="margin-top:50px;margin-top:100px;">
	<label>商品描述：</label>
	<br/>
...
<div class="float_left">
	...
	<tr>
		<td width="240">
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_name_1" name="format_name_1" onchange="change_format(1, this.value)">
		...
		<td width="240">
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_name_2" name="format_name_2" onchange="change_format(2, this.value)">
				<option value="0">-- 无 --</option>
				<xsl:for-each select="/html/Body/format_name/li">
					<xsl:element name="OPTION">
						<xsl:attribute name="value"><xsl:value-of select="@id" /></xsl:attribute>
		...
		<td width="240">
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_name_3" name="format_name_3" onchange="change_format(3, this.value)">
				<option value="0">-- 无 --</option>
				<xsl:for-each select="/html/Body/format_name/li">
					<xsl:element name="OPTION">
						<xsl:attribute name="value"><xsl:value-of select="@id" /></xsl:attribute>
		...
		<td width="240">
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_name_4" name="format_name_4" onchange="change_format(4, this.value)">
				<option value="0">-- 无 --</option>
				<xsl:for-each select="/html/Body/format_name/li">
					<xsl:element name="OPTION">
						<xsl:attribute name="value"><xsl:value-of select="@id" /></xsl:attribute>
		...
		<td width="240">
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_name_5" name="format_name_5" onchange="change_format(5, this.value)">
				<option value="0">-- 无 --</option>
				<xsl:for-each select="/html/Body/format_name/li">
					<xsl:element name="OPTION">
						<xsl:attribute name="value"><xsl:value-of select="@id" /></xsl:attribute>
	...
	<tr>
		<td>
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_value_1" name="format_value_1">
				<xsl:for-each select="/html/Body/format_value/li">
		...
		<td>
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_value_2" name="format_value_2">
				<xsl:for-each select="/html/Body/format_value/li">
		...
		<td>
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_value_3" name="format_value_3">
				<xsl:for-each select="/html/Body/format_value/li">
		...
		<td>
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_value_4" name="format_value_4">
				<xsl:for-each select="/html/Body/format_value/li">
		...
		<td>
			<select class="form-control form_no_border input-sm" disabled="disabled" id="format_value_5" name="format_value_5">
				<xsl:for-each select="/html/Body/format_value/li">
	...
	<div class="propertys">
		...
		<tr>
			...
			<th width="400" class="center">属性</th>
			<th width="750">属性值</th>
		</tr>
	...
	<div class="table_operate_block" style="margin:-15 0 0 0;">
			<h4>商品仓库</h4>
	</div>
