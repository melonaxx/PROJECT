...
<div class="mainBody">
	<ul id="myTab" class="nav nav-tabs nav_tabs_margin">
	   ...
	   <li  class="active"><a href="deliver_single_r.php">待处理</a></li>
	</ul>
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane fade in active" id="reser_voirarea">
			<div class="headMsg table_operate_block">
				<form class="form-inline" method="get" action="deliver_single_r.php">
					<div class="form-group float_right margin0">
						<div class="input-group">
							<input type="text" style="width:300px;" class="form-control input-sm" placeholder="输入订单编号查询" name="find" />
