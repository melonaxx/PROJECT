...
<script type="text/javascript" src="/js_encode/deliver_edit_order.js"></script>
<!-- 时间插件 -->
...
<div class="mainBody">
<form class="form-inline margin_top_add2" action="/deliver/deliver_edit_order.php" method="post">
	<div class="orderMsg">
		...
		<div class="supplierMsg">
		   <div class="form-group">
			...
			<div class="form-group margin_left_block">
				<label>发票收据：</label>
				<select class="form-control input-sm shouju" name="need_invoice" disabled="disabled">
			...
			<div class="form-group">
				<label>快递公司：</label>
				<select class="form-control input-sm express" name="express_id" disabled="disabled">
			...
			<table style="margin-top:10px;width:1200px;" class="table table-bordered table-hover">
				...
				<tr>
					...
					<td class="order_add_td_2" style="width:100px;">
						<div class="input-group">
						  <div class="input-group-addon">￥<xsl:value-of select='discount' /></div>
						</div>
					</td>
					<td class="order_add_td_2" style="width:80px;">
						<div class="input-group">
		...
		<div class="commonMsg totalMsg">
			<p>商品总金额
				...
				<select class="form-control input-sm" disabled="disabled" name="is_audit" style="width:147px;">
