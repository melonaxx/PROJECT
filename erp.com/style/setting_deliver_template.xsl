...
<!-- <script type="text/javascript" src="/js_encode/deliver_deliver_printing.js"></script> -->
<!-- <script type="text/javascript" src="/js_encode/LodopFuncs.js"></script> -->
	...
	<ul id="myTab" class="nav nav-tabs nav_tabs_margin">
		<li>
	   	...
	   	<li class="active"><a href="#" data-toggle="tab">发货单模板</a></li>
	   	<li>
	   		<a href="/setting/setting_order_template.php">配货单模板</a>
		</li>
	</ul>
	<div class="headMsg table_operate_block">
		<div class="form-group float_right margin0">
		<form action="/setting/setting_deliver_template.php" method="post" class="form-inline">
		...
		<a href="/deliver/deliver_design_deliver.php" target="_blank"><input class="btn btn-default btn-sm btn_margin" type="button" value="添加" /></a>
		<a href="/setting/setting_express_template_sys_d.php" target="_blank"><input class="btn btn-default btn-sm btn_margin" type="button" value="系统模板" /></a>
	...
	<table style="" class="table tab_select table-bordered table-hover">
		...
		<xsl:for-each select="/html/Body/deliverInfo/item">
		<tr>
			...
			<td class="center">
				<xsl:element name="A">
					...
					<xsl:attribute name="href">/deliver/deliver_design_deliver.php?template_id=<xsl:value-of select = 'id'/></xsl:attribute>
				<xsl:text>设计</xsl:text>
				</xsl:element>
				
				<xsl:element name="A">
					<xsl:attribute name="class">table_a_operate delete</xsl:attribute>
					<xsl:attribute name="href">/setting/setting_delete_deliver_template.php?id=<xsl:value-of select = 'id'/></xsl:attribute>
				...
				<xsl:element name="A">
					<xsl:attribute name="class">table_a_operate</xsl:attribute>
					<xsl:attribute name="href">/setting/setting_deliver_template.php?default="Y"&amp;id=<xsl:value-of select = 'id'/></xsl:attribute>
	...
	<xsl:if test="/html/Body/deliverInfo/@total = '0'">
