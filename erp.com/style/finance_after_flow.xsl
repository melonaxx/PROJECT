...
<div class="mainBody">
	<ul id="myTab" class="nav nav-tabs" style="margin-bottom:10px;">
	   <li><a href="finance_order_flow.php">订单流水</a></li>
	   <li class="active"><a href="finance_after_flow.php">退款流水</a></li>
	</ul>
		...
		<table width="1180" class="table table-bordered table-hover">
			...
			<xsl:for-each select="/html/Body/fin_order/ul/li">
				<tr>
					...
					<td><xsl:value-of select="after_date"/></td>
					...
					<td><xsl:value-of select="refund"/></td>
