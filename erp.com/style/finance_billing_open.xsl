...
<div class="mainBody">
	<ul id="myTab" class="nav nav-tabs">
	   <li><a href="/finance/finance_for_billing.php">待开票</a></li>
	   <li class="active"><a href="#BREW" data-toggle="tab">已开票</a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane fade in active" id="BREW">
			<div class="mainBody">
				...
				<div class="goodsMsg" style="clear:both;">
					...
					<div class="table_operate_block"  style="margin-bottom:0px;">
						<div class="form-group float_right margin0">
							<form class="form-inline" method="get" action="/finance/finance_billing_open.php">
							<div class="form-group form-group_1 btn_margin">
								...
								<xsl:element name="INPUT">
									...
									<xsl:attribute name="id">MerchandiseQuery</xsl:attribute>
								</xsl:element>
							</div>
					...
					<tr>
						...
						<td class="center" >
							...
							<xsl:element name="A">
								...
								<xsl:if test="'普通发票'=tax_type">
									<xsl:attribute name="onclick">MessageBox("/finance/finance_invoice_Normal.php?id=<xsl:value-of select = 'id'/>","发票详细",600,260)</xsl:attribute>
								</xsl:if>
								<xsl:if test="'增值税发票'=tax_type">
									<xsl:attribute name="onclick">MessageBox("/finance/finance_invoice_VAT.php?id=<xsl:value-of select = 'id'/>","发票详细",600,335)</xsl:attribute>
								</xsl:if>
								<xsl:text>发票</xsl:text>
							</xsl:element>
						</td>
