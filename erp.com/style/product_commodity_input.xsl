...
<script type="text/javascript" src="/js_encode/product_commodity_input.js"></script>
<script type="text/javascript" src="/js_encode/jquery.area.three.js"></script>
<script type="text/javascript" src="/js_encode/jquery.form.js"></script>
...
<form class="form-inline margin_top"  method="post" action="/product/product_commodity_input.php">
<div>
 	<h4>商品信息</h4>
	<div  class="float_left" style="height:250px;width:700px">
		...
		<div class="form-group">
			...
			<xsl:element name="INPUT">
				...
				<xsl:attribute name="placeholder">不填写自动生成</xsl:attribute>
			</xsl:element>
		</div>
		<div class="form-group">
			<label>商品品牌：</label>
			<select class="form-control input-sm" name="brand">
				...
				<xsl:for-each select="/html/Body/supplierMsg/type/ul/li">
					<xsl:element name="OPTION">
						...
						<xsl:if test="value=/html/Body/supplierMsg/brand/select_value"><xsl:value-of select="number" /></xsl:if>
			...
			<div class="form-group">
				...
				<xsl:element name="INPUT">
					...
					<xsl:attribute name="placeholder">默认和商品编码相同</xsl:attribute>
				</xsl:element>
			</div>
			<div class="form-group">
				<label>产品类型：</label>
	...
	<div class="float_left" style="width:1200px"><h4>商品规格</h4><div>
...
<!-- 	<xsl:for-each select="/html/Body/attrib_name/li">
	<div class="form-group nature">
		...
		<table width="1180" class="table table-bordered table-property ttbale  table-hover">
	...
	<input class="btn btn-default btn-sm propertyDeleteaa" type="button" value="删除" />
			...
			<tr>
				...
				<td class="form-group namena">
					<select class="form-control form_no_border input-sm" id="bb" name="value_id[]">
					</select>						
				</td>
			</tr>
		</table>
	...
	<div class="table_operate_block">
		<table class="table table-bordered table-accessories ttbale  table-hover">
			...
			<tr>
				...
				<td class="form-group namena"><div class="div"></div></td>
