$(function(){
    ...
    $(".searchbtn").click(function(){
        ...
        util.ajax_post("searchplatform.php",data,searSuccess,searFail);
    });
    ...
    function searSuccess(data){
        if(data == null || data == ""){
            ...
            for(var i=0;i<data.length;i++){
                str += "<li class='wllevel'><a href='/main.php?status=search&platformid="+data[i]['id']+"'><span>"+(i+1)+".</span><span>"+data[i]['name']+"</span><p></p></a> </li>";
            }
            $(".wmainlist li:eq(2)").nextAll().empty();
